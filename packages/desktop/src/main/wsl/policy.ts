import type { WslDistroProbe, WslKiloCheck, WslServerItem } from "../../preload/types"
...
export function clearWslDistroState(
  ...
  const nextKiloChecks = { ...kiloChecks }
  delete nextDistroProbes[distro]
  delete nextKiloChecks[distro]
  return { distroProbes: nextDistroProbes, kiloChecks: nextKiloChecks }
}
